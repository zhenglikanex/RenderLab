...
bool OpenGLShaderManager::Initialize()
{
	return InitializeShaders();
}

void OpenGLShaderManager::Finalize()
{
	ClearShaders();
}

void OpenGLShaderManager::Tick()
{
...
void* OpenGLShaderManager::GetDefaultShaderProgram()
{
...
void* OpenGLShaderManager::GetDebugShaderProgram()
{
